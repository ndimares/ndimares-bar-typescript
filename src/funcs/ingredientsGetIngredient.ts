 ...
 */
export async function ingredientsGetIngredient(
  client: NdimaresBarCore,
  name: string,
  options?: RequestOptions,
): Promise<
  Result<
    operations.GetIngredientResponse,
    | errors.APIError
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  ...
  const path = pathToFunc("/ingredient/{name}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetIngredientResponse$inboundSchema, {
      key: "Ingredient",
    }),
    M.fail("4XX"),
    M.jsonErr("5XX", errors.APIError$inboundSchema),
    M.json("default", operations.GetIngredientResponse$inboundSchema, {
      key: "Error",
    }),
