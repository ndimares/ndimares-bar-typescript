...
export namespace ListDrinksSecurity$ {
    export const inboundSchema: z.ZodType<ListDrinksSecurity, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListDrinksSecurity> = z
        .object({
            bearerAuth: z.string().optional(),
        })
        .transform((v) => {
...
export namespace ListDrinksResponse$ {
    export const inboundSchema: z.ZodType<ListDrinksResponse, z.ZodTypeDef, unknown> = z
        ...
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
                ...(v.Drinks === undefined ? null : { drinks: v.Drinks }),
